...
export function Footer() {
  return (
    <footer
      data-tone="dark"
      className="flex w-full flex-col gap-8 rounded-none bg-ink px-4 py-10 lg:gap-12 lg:rounded-card lg:px-[68px] lg:py-[50px]"
    >
              ...
              <ul className="flex flex-col gap-2.5">
                {col.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="font-body text-[16px] text-text-dim"
                    >
                      {link.label}
                    </Link>
                  </li>
