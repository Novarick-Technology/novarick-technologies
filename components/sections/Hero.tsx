...
export function Hero() {
  ...
  return (
    ...
    >
      ...
      <div className="absolute left-3 top-6 z-10 flex h-[52px] w-[calc(100%-29px)] max-w-[361px] items-center justify-between rounded-pill border border-white/10 bg-white/[0.14] px-6 py-2 min-[900px]:left-1/2 min-[900px]:top-[42px] min-[900px]:h-auto min-[900px]:w-auto min-[900px]:max-w-none min-[900px]:-translate-x-1/2 min-[900px]:justify-start min-[900px]:gap-6 min-[900px]:py-2 min-[900px]:pl-5 min-[900px]:pr-2 2xl:gap-8 2xl:pl-6 2xl:pr-3">
        <Link href="/" className="shrink-0">
          <Logo tone="white" className="h-[21.6px] w-auto min-[900px]:h-[26px]" />
        </Link>
        <ul className="hidden whitespace-nowrap font-body text-[15px] text-white min-[900px]:flex min-[900px]:items-center min-[900px]:gap-6 2xl:gap-8">
          {navLinks.map((link) => (
